...
function setup() 
{
  ...
  stardisplay.addAnimation('emptystar', empty);
  stardisplay.addAnimation('one', onestar);
  stardisplay.addAnimation('two', twostar);
  stardisplay.changeAnimation('emptystar', empty);
  ...
  star1 = createSprite(340,50,20,20);
  star1.addImage('stars', starimg);
  star1.scale = 0.02;

  star2 = createSprite(60,350,20,20);
